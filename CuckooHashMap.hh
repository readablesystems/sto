...
//! DEFAULT_SIZE is the default number of elements in an empty hash table
...
public:
     ...
     * exception. */
    explicit CuckooHashMap(size_t n = DEFAULT_SIZE) {
...
__thread void** CuckooHashMap<Key, T, Hash, Pred>::hazard_pointer_old = nullptr;

template <class Key, class T, class Hash, class Pred>
__thread void** CuckooHashMap<Key, T, Hash, Pred>::hazard_pointer_new = nullptr;

template <class Key, class T, class Hash, class Pred>
__thread int CuckooHashMap<Key, T, Hash, Pred>::counterid = -1;

template <class Key, class T, class Hash, class Pred>
typename CuckooHashMap<Key, T, Hash, Pred>::hasher
CuckooHashMap<Key, T, Hash, Pred>::hashfn;

template <class Key, class T, class Hash, class Pred>
typename CuckooHashMap<Key, T, Hash, Pred>::key_equal
CuckooHashMap<Key, T, Hash, Pred>::eqfn;

template <class Key, class T, class Hash, class Pred>
typename std::allocator<typename CuckooHashMap<Key, T, Hash, Pred>::Bucket>
CuckooHashMap<Key, T, Hash, Pred>::bucket_allocator;

template <class Key, class T, class Hash, class Pred>
typename CuckooHashMap<Key, T, Hash, Pred>::GlobalHazardPointerList
CuckooHashMap<Key, T, Hash, Pred>::global_hazard_pointers;

template <class Key, class T, class Hash, class Pred>
const size_t CuckooHashMap<Key, T, Hash, Pred>::kNumCores =
    std::thread::hardware_concurrency() == 0 ?
    sysconf(_SC_NPROCESSORS_ONLN) : std::thread::hardware_concurrency();

template <class Key, class T, class Hash, class Pred>
std::atomic<size_t> CuckooHashMap<Key, T, Hash, Pred>::numThreads(0);
