...
enum {
    opt_nthreads, opt_ntrans, opt_opspertrans, opt_searchpercent, opt_pushbackpercent, opt_prepopulate, opt_seed, opt_usesmartiterators
};
...
static const Clp_Option options[] = {
    ...
    { "usesmartiterators", 0, opt_usesmartiterators, Clp_ValInt, Clp_Optional}
};
    ...
    while ((opt = Clp_Next(clp)) != Clp_Done) {
        switch (opt) {
            ...
            case opt_seed:
                ...
                break;
            case opt_usesmartiterators:
                use_smartiterators = clp->val.i == 1;
                break;
            default:
                help();
        }
