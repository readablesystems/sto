...
struct hint_tpcc_fulfill_order_traits {
  static const size_t read_set_expected_size = 45;
  static const size_t write_set_expected_size = 45;
...
#define TXN_PROFILE_HINT_OP(x) \
  ...
  x(abstract_db::HINT_TPCC_FULFILL_ORDER, hint_tpcc_fulfill_order_traits) \
