...
main(int argc, char **argv)
{
  ...
  while (1) {
    static struct option long_options[] =
    {
      ...
      // for checkpointing and replay
      {"enable-ckp"                 , no_argument       , &enable_ckp                , 1}   ,
      {"enable-ckp-compress"        , no_argument       , &enable_ckp_compress       , 1}   ,
      {"enable-datastripe"          , no_argument       , &enable_datastripe         , 1}   ,
      {"enable-datastripe-par"      , no_argument       , &enable_datastripe_par     , 1}   ,
      {"enable-par-ckp"             , no_argument       , &enable_par_ckp            , 1}   ,
      {"enable-par-log-replay"      , no_argument       , &enable_par_log_replay     , 1}   ,
      {"ckp-th"                     , required_argument , 0                          , 'h'} ,      
      {"ckp-dirs"                   , required_argument , 0                          , 'c'} ,
      {"root-dir"                   , required_argument , 0                          , 'R'} ,
      {"ckp-compress"               , no_argument       , &ckp_compress              , 1}   ,
      {"reduced-ckp"                , no_argument ,       &reduced_ckp               , 'k'} ,
      {"stats-file"                 , required_argument , 0                          , 'z'} ,
      {"stats-counters"             , required_argument , 0                          , 'j'} ,
      {"run-for-ckp"                , required_argument , 0                          , 'p'} ,
      {"recovery-test"              , no_argument       , &recovery_test             , 'w'} ,
      {0, 0, 0, 0}
    };
    int option_index = 0;
    ...
    case 'c':
      ckpdirs.emplace_back(ParseCSVString<string, StringParser>(optarg));
      break;
