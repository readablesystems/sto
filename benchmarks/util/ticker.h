...
private:
  ...
  tickerloop()
  {
	...
	/* time_start = start.tv_sec; */
	/* time_start += (double) start.tv_usec / 1000000; */
	/* time_finish = end.tv_sec; */
	/* time_finish += (double) end.tv_usec / 1000000; */
	/* time = time_finish - time_start; */
	/* if (time > 1) */
	/*   printf("Unlocking %lu took %f s\n", i, time); */
