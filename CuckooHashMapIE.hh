#ifndef _CuckooHashMapIE_HH
#define _CuckooHashMapIE_HH
...
class CuckooHashMapIE: public Shared {
     ...
     * CuckooHashMapIE operations can run simultaneously in different
     * threads, this variable is thread local. Note that this variable
     * can be safely shared between different CuckooHashMapIE
    ...
    // means each template instantiation of a CuckooHashMapIE class
    // gets its own per-thread hazard pointer, then each template
    // instantiation of a CuckooHashMapIE class can get its own
...
public:
     ...
     * exception. */
    explicit CuckooHashMapIE(size_t n = Num_Buckets * SLOT_PER_BUCKET) {
