...
std::string cpp_col_cell_map_init_list(std::pair<std::vector<Field>,std::vector<std::vector<std::string>>>& result) {
    std::stringstream ss;
    auto& fields = result.first;
    auto& groups = result.second;
...
void generate_code(std::pair<std::vector<Field>,std::vector<std::vector<std::string>>> &result) {
    std::stringstream ss;
    std::string struct_name = "my_row_type"; // XXX need to parse this also
