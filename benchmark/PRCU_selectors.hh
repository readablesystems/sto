...
class VerSel<prcubench::ht_value, VersImpl> : public VerSelBase<VerSel<prcubench::ht_value, VersImpl>, VersImpl> {
public:
    ...
    void install_by_cell_impl(prcubench::ht_value *dst, const prcubench::ht_value *src, int) {
        *dst = *src;
    }
