// Defines the commutators for Dynamic structs
...
using warehouse_value = dynamic::warehouse_value;
//using warehouse_value_frequpd = dynamic::warehouse_value_frequpd;
//using warehouse_value_infreq = dynamic::warehouse_value_infreq;

using district_value = dynamic::district_value;
//using district_value_frequpd = dynamic::district_value_frequpd;
//using district_value_infreq = dynamic::district_value_infreq;

using customer_value = dynamic::customer_value;
//using customer_value_frequpd = dynamic::customer_value_frequpd;
//using customer_value_infreq = dynamic::customer_value_infreq;

using order_value = dynamic::order_value;
//using order_value_frequpd = dynamic::order_value_frequpd;
//using order_value_infreq = dynamic::order_value_infreq;

using orderline_value = dynamic::orderline_value;
//using orderline_value_frequpd = dynamic::orderline_value_frequpd;
//using orderline_value_infreq = dynamic::orderline_value_infreq;

using stock_value = dynamic::stock_value;
//using stock_value_frequpd = dynamic::stock_value_frequpd;
//using stock_value_infreq = dynamic::stock_value_infreq;

using dynamic::c_data_info;
