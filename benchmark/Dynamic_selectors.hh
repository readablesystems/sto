...
class VerSel<dynamic::warehouse_value, VersImpl> : public VerSelBase<VerSel<dynamic::warehouse_value, VersImpl>, VersImpl> {
public:
    ...
    constexpr static int map_impl(int col_n) {
        typedef dynamic::warehouse_value::NamedColumn nc;
    ...
    void install_by_cell_impl(dynamic::warehouse_value *dst, const dynamic::warehouse_value *src, int cell) {
        switch (cell) {
        case 0:
            dst->w_ytd = src->w_ytd;
            break;
...
template <typename VersImpl>
class VerSel<dynamic::district_value, VersImpl> : public VerSelBase<VerSel<dynamic::district_value, VersImpl>, VersImpl> {
public:
    typedef VersImpl version_type;
    static constexpr size_t num_versions = 2;
    ...
    constexpr static int map_impl(int col_n) {
        typedef dynamic::district_value::NamedColumn nc;
        auto col_name = static_cast<nc>(col_n);
    ...
    void install_by_cell_impl(dynamic::district_value *dst, const dynamic::district_value *src, int cell) {
        switch (cell) {
        case 0:
            dst->d_ytd = src->d_ytd;
            break;
...
template <typename VersImpl>
class VerSel<dynamic::customer_value, VersImpl> : public VerSelBase<VerSel<dynamic::customer_value, VersImpl>, VersImpl> {
public:
    typedef VersImpl version_type;
    static constexpr size_t num_versions = 2;
    ...
    void install_by_cell_impl(dynamic::customer_value *dst, const dynamic::customer_value *src, int cell) {
        switch (cell) {
        case 0:
...
template <typename VersImpl>
class VerSel<dynamic::order_value, VersImpl> : public VerSelBase<VerSel<dynamic::order_value, VersImpl>, VersImpl> {
public:
    typedef VersImpl version_type;
    static constexpr size_t num_versions = 2;
    ...
    void install_by_cell_impl(dynamic::order_value *dst, const dynamic::order_value *src, int cell) {
        switch (cell) {
            case 0:
...
template <typename VersImpl>
class VerSel<dynamic::orderline_value, VersImpl> : public VerSelBase<VerSel<dynamic::orderline_value, VersImpl>, VersImpl> {
public:
    typedef VersImpl version_type;
    static constexpr size_t num_versions = 2;
    ...
    void install_by_cell_impl(dynamic::orderline_value *dst, const dynamic::orderline_value *src, int cell) {
        switch (cell) {
            case 0:
...
template <typename VersImpl>
class VerSel<dynamic::stock_value, VersImpl> : public VerSelBase<VerSel<dynamic::stock_value, VersImpl>, VersImpl> {
public:
    typedef VersImpl version_type;
    static constexpr size_t num_versions = 2;
    ...
    static int map_impl(int col_n) {
        typedef dynamic::stock_value::NamedColumn nc;
    ...
    void install_by_cell_impl(dynamic::stock_value *dst, const dynamic::stock_value *src, int cell) {
        switch (cell) {
            case 0:
