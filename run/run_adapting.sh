...
cd results
join -t, --header --nocheck-order adapting_100opt_results.txt adapting_1000opt_results.txt | join -t, --header --nocheck-order - adapting_100opt_4sp_results.txt | join -t, --header --nocheck-order - adapting_1000opt_4sp_results.txt > adapting_results.txt
