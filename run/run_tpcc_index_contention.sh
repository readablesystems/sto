...
setup_tpcc_occ_idx_cont  # Change this accordingly!
...
rm -rf results
mkdir results
RFILE=results/tpcc_index_contention_results.txt
DFILE=results/tpcc_index_contention_delivery_results.txt
